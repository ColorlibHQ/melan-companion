...
class Melan_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Melan ] Social Links', 'melan-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'melan-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'melan-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'melan-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'melan-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'melan-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'melan-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'melan-companion'); ?></label>
...
} // Class melan_social_links ends here


// Register and load the widget
function melan_social_links_widget_load() {
	register_widget( 'Melan_social_links' );
}
add_action( 'widgets_init', 'melan_social_links_widget_load' );