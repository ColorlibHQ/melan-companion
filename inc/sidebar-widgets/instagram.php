...
----------------------------------------*/
class melan_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('melan_instagram_photo',esc_html__('[ Melan ] Intagram Photo','melan-companion'),array(
			'description' => esc_html__('Melan Instagram Photo Widget','melan-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'melan-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'melan-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'melan-companion'); ?></label>
...
if(!function_exists('melan_instagram_widgets')):
	function melan_instagram_widgets(){
		register_widget('melan_instagram_photo');
	}
	add_action('widgets_init','melan_instagram_widgets');
endif;
