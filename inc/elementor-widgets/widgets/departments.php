...
/**
 *
 * Melan elementor departments section widget.
 *
 * @since 1.0
 */
class Melan_Departments extends Widget_Base {

	public function get_name() {
		return 'melan-departments';
	}

	public function get_title() {
		return __( 'Departments', 'melan-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'departments_content',
			[
				'label' => __( 'Departments Section', 'melan-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Our Departments', 'melan-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
		...
		$this->add_control(
            'departments', [
                ...
                'fields' => [
                    [
                        'name' => 'item_img',
                        'label' => __( 'Department Image', 'melan-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_title',
                        'label' => __( 'Department Title', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Eye Care', 'melan-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Department Text', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Esteem spirit temper too say adieus who direct esteem.', 'melan-companion' ),
                    ],
                    [
                        'name' => 'btn_text',
                        'label' => __( 'Button Text', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Learn More', 'melan-companion' ),
                    ],
                    [
                        'name' => 'btn_url',
                ...
                'default'   => [
                    [      
                        ...
                        'item_title' => __( 'Eye Care', 'melan-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'melan-companion' ),
                        'btn_text'   => __( 'Learn More', 'melan-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                        ],
                    ],
                    [      
                        ...
                        'item_title' => __( 'Physical Therapy', 'melan-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'melan-companion' ),
                        'btn_text'   => __( 'Learn More', 'melan-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Dental Care', 'melan-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'melan-companion' ),
                        'btn_text'   => __( 'Learn More', 'melan-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Diagnostic Test', 'melan-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'melan-companion' ),
                        'btn_text'   => __( 'Learn More', 'melan-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Skin Surgery', 'melan-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'melan-companion' ),
                        'btn_text'   => __( 'Learn More', 'melan-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Surgery Service', 'melan-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'melan-companion' ),
                        'btn_text'   => __( 'Learn More', 'melan-companion' ),
                        'btn_url'    => [
                            'url' => '#'
     ...
     */
        ...
        $this->add_control(
            'sec_bg_col', [
                'label' => __( 'Section Bg Color', 'melan-companion' ),
        ...
        $this->add_control(
            'title_hover_col', [
                'label' => __( 'Title Hover Color', 'melan-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'anchor_text_col', [
                'label' => __( 'Anchor Text Color', 'melan-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="row">
                ...
                if( is_array( $departments ) && count( $departments ) > 0 ) {
                    foreach( $departments as $department ) {
                        ...
                        $item_img = !empty( $department['item_img']['id'] ) ? wp_get_attachment_image( $department['item_img']['id'], 'melan_department_thumb_362x240', '', array('alt' => $item_title . ' image' ) ) : '';
