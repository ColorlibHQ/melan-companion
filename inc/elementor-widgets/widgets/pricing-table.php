...
/**
 *
 * Melan Pricing Table Contents section widget.
 *
 * @since 1.0
 */
class Melan_Pricing_Contents extends Widget_Base {

	public function get_name() {
		return 'melan-pricing-contents';
	}

	public function get_title() {
		return __( 'Pricing Contents', 'melan-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'pricing_content',
			[
				'label' => __( 'Pricing Contents', 'melan-companion' ),
			]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => __( 'Unlock full Power', 'melan-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
		...
		$this->add_control(
            'pricing', [
                ...
                'fields' => [
                    [
                        'name' => 'pack_name',
                        'label' => __( 'Package Name', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Basic', 'melan-companion' ),
                    ],
                    [
                        'name' => 'pack_price',
                        'label' => __( 'Package Price', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '$06', 'melan-companion' ),
                    ],
                    [
                        'name' => 'fet_1',
                        'label' => __( 'Feature 1', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'One User', 'melan-companion' ),
                    ],
                    [
                        'name' => 'fet_2',
                        'label' => __( 'Feature 2', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '1000 ui elements', 'melan-companion' ),
                    ],
                    [
                        'name' => 'fet_3',
                        'label' => __( 'Feature 3', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Webmail Support', 'melan-companion' ),
                    ],
                    [
                        'name' => 'fet_4',
                        'label' => __( 'Feature 4', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '100GB Cloud Storage', 'melan-companion' ),
                    ],
                    [
                        'name' => 'fet_5',
                        'label' => __( 'Feature 5', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Unlimited Users Limit', 'melan-companion' ),
                    ],
                    [
                        'name' => 'btn_label',
                        'label' => __( 'Button Label', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Get Now', 'melan-companion' ),
                    ],
                    [
                        'name' => 'btn_url',
                        'label' => __( 'Button URL', 'melan-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [
                        'pack_name'       => __( 'Basic', 'melan-companion' ),
                        'pack_price'      => __( '$06', 'melan-companion' ),
                        'fet_1'           => __( 'One User', 'melan-companion' ),
                        'fet_2'           => __( '1000 ui elements', 'melan-companion' ),
                        'fet_3'           => __( 'Webmail Support', 'melan-companion' ),
                        'fet_4'           => __( '100GB Cloud Storage', 'melan-companion' ),
                        'fet_5'           => '',
                        'btn_label'       => __( 'Get Now', 'melan-companion' ),
                        'btn_url'         => [
                            'url'         => '#'
                        ],
                    ],
                    [
                        'pack_name'       => __( 'Team', 'melan-companion' ),
                        'pack_price'      => __( '$16', 'melan-companion' ),
                        'fet_1'           => __( '10 Users', 'melan-companion' ),
                        'fet_2'           => __( '10000 ui elements', 'melan-companion' ),
                        'fet_3'           => __( 'Webmail Support', 'melan-companion' ),
                        'fet_4'           => __( '1000GB Cloud Storage', 'melan-companion' ),
                        'fet_5'           => __( 'Unlimited Users Limit', 'melan-companion' ),
                        'btn_label'       => __( 'Get Now', 'melan-companion' ),
                        'btn_url'         => [
                            'url'         => '#'
                        ],
                    ...
                    [
                        'pack_name'       => __( 'Business', 'melan-companion' ),
                        'pack_price'      => __( '$26', 'melan-companion' ),
                        'fet_1'           => __( 'Unlimited User', 'melan-companion' ),
                        'fet_2'           => __( '100000 ui elements', 'melan-companion' ),
                        'fet_3'           => __( 'Webmail Support', 'melan-companion' ),
                        'fet_4'           => __( '10000GB Cloud Storage', 'melan-companion' ),
                        'fet_5'           => '',
                        'btn_label'       => __( 'Get Now', 'melan-companion' ),
                        'btn_url'         => [
                            'url'         => '#'
