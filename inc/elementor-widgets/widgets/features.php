...
/**
 *
 * Melan elementor features section widget.
 *
 * @since 1.0
 */
class Melan_Features extends Widget_Base {

	public function get_name() {
		return 'melan-features';
	}

	public function get_title() {
		return __( 'App Features', 'melan-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'features_content',
			[
				'label' => __( 'Features content', 'melan-companion' ),
			]
        );
        $this->add_control(
            'left_img',
            [
                'label' => esc_html__( 'Left Image', 'melan-companion' ),
                'description' => esc_html__( 'Best size is 372x655', 'melan-companion' ),
        ...
        $this->add_control(
            'right_img',
            [
                'label' => esc_html__( 'Right Image', 'melan-companion' ),
                'description' => esc_html__( 'Best size is 561x707', 'melan-companion' ),
                'type' => Controls_Manager::MEDIA,
                'label_block' => true,
                'default'     => [
                    'url'   => Utils::get_placeholder_image_src(),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Features', 'melan-companion' ),
            ...
            'features', [
                ...
                'fields' => [
                    [
                        ...
                        'default'     => __( 'Sign Up for free', 'melan-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Short Text', 'melan-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [      
                        'item_title'    => __( 'Sign Up for free', 'melan-companion' ),
                        'item_text'   => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'melan-companion' ),
                    ],
                    [      
                        'item_title'    => __( 'Make your profile', 'melan-companion' ),
                        'item_text'   => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'melan-companion' ),
                    ],
                    [      
                        'item_title'    => __( 'Enjoy the app', 'melan-companion' ),
                        'item_text'   => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'melan-companion' ),
                    ],
                ]
            ]
    ...
    $left_img  = !empty( $settings['left_img']['id'] ) ? wp_get_attachment_image( $settings['left_img']['id'], 'melan_service_man_thumb_372x655', '', array( 'alt' => 'left image' ) ) : '';
    $right_img = !empty( $settings['right_img']['id'] ) ? wp_get_attachment_image( $settings['right_img']['id'], 'melan_service_right_thumb_561x707', '', array( 'alt' => 'right image' ) ) : '';
