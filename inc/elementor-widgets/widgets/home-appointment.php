...
/**
 *
 * Melan elementor home appointment section widget.
 *
 * @since 1.0
 */
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'home_contact_sec_style', [
                'label' => __( 'Home Contact Section Styles', 'melan-companion' ),
        ...
        $this->add_control(
			'btn_hvr_border_bg_col', [
				'label' => __( 'Button Hover Border & Bg Color', 'melan-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
