...
/**
 *
 * Melan elementor contact info section section widget.
 *
 * @since 1.0
 */
class Melan_Contact_Info_Section extends Widget_Base {

	public function get_name() {
		return 'melan-emergency-contact-section';
	}

	public function get_title() {
		return __( 'Emergency Contact Section', 'melan-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Emergency Contact Section', 'melan-companion' ),
            ]
        );
        $this->add_control(
            'ec_bg_img',
            [
                'label' => esc_html__( 'BG Image', 'melan-companion' ),
        ...
        $this->add_control(
            'ec_title',
            [
                'label' => esc_html__( 'Sec Title', 'melan-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'For Any Information Call Us', 'melan-companion' ),
            ]
        );
        $this->add_control(
            'ec_text',
            [
                ...
                'label_block' => true,
                'default' => esc_html__( 'Esteem spirit temper too say adieus who direct esteem.', 'melan-companion' ),
            ]
        );
        $this->add_control(
            'ec_btn_label',
            [
                'label' => esc_html__( 'Phone', 'melan-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( '+10 673 763 6786', 'melan-companion' ),
            ]
        );
        ...
        $this->start_controls_section(
            'left_sec_style', [
                'label' => __( 'Top Section Styles', 'melan-companion' ),
        ...
        $this->add_control(
			'button_hover_col', [
				'label' => __( 'Button Hover Bg Color', 'melan-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Overlay Color Styles', 'melan-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
			'sec_title_col', [
				'label' => __( 'Bg Overlay Color', 'melan-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
    ...
    <!-- Information_area  -->
    <div class="Information_area overlay" <?php echo melan_inline_bg_img( esc_url( $ec_bg_img ) ); ?>>
        <div class="container">
