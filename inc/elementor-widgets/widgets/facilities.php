...
/**
 *
 * Melan elementor facilities section widget.
 *
 * @since 1.0
 */
class Melan_Facilities extends Widget_Base {

	public function get_name() {
		return 'melan-facilities';
	}

	public function get_title() {
		return __( 'App Facilities', 'melan-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'facilities_content',
			[
				'label' => __( 'Facilities content', 'melan-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default' => 'Save your time to <br>using melan',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Facilities', 'melan-companion' ),
            ...
            <div class="row">
                ...
                if( is_array( $facilities ) && count( $facilities ) > 0 ) {
                    foreach( $facilities as $item ) {
                        $item_icon = ( !empty( $item['item_icon'] ) ) ? MELAN_DIR_ICON_IMG_URI . $item['item_icon'] : '';
