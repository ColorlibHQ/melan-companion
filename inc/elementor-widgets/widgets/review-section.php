...
/**
 *
 * Melan Review Contents section widget.
 *
 * @since 1.0
 */
class Melan_Review_Contents extends Widget_Base {

	public function get_name() {
		return 'melan-review-contents';
	}

	public function get_title() {
		return __( 'Review Contents', 'melan-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'reviews_content',
			[
				'label' => __( 'Review Contents', 'melan-companion' ),
			]
        );
		...
		$this->add_control(
            'reviews', [
                ...
                'fields' => [
                    [
                        'name' => 'review_txt',
                        'label' => __( 'Review Text', 'melan-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'client_img',
                        'label' => __( 'Client Image', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::MEDIA,
                        'default' => [
                            'url' => Utils::get_placeholder_image_src()
                    ...
                    [
                        ...
                        'default' => __( 'Robert Thomson', 'melan-companion' ),
                    ],
                    [
                        'name' => 'reviewer_designation',
                        'label' => __( 'Client Designation', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Business Owner', 'melan-companion' ),
                    ],
                ],
                'default'   => [
                    [
                        ...
                        'reviewer_name'         => __( 'Robert Thomson', 'melan-companion' ),
                        'reviewer_designation'  => __( 'Business Owner', 'melan-companion' ),
                    ],
                    [
                        'review_txt'            => 'Donec imperdiet congue orci consequat mattis. Donec rutrum porttitor <br> sollicitudin. Pellentesque id dolor tempor sapien feugiat ultrices nec sed neque.  <br> Fusce ac mattis nulla. Morbi eget ornare dui.',
                        'client_img'         => [
                        ...
                        'reviewer_name'         => __( 'Jonathan Doe', 'melan-companion' ),
                        'reviewer_designation'  => __( 'Business Owner', 'melan-companion' ),
                    ],
                    [
                        'review_txt'            => 'Donec imperdiet congue orci consequat mattis. Donec rutrum porttitor <br> sollicitudin. Pellentesque id dolor tempor sapien feugiat ultrices nec sed neque.  <br> Fusce ac mattis nulla. Morbi eget ornare dui.',
                        ...
                        'reviewer_name'         => __( 'John Doe', 'melan-companion' ),
                        'reviewer_designation'  => __( 'Business Owner', 'melan-companion' ),
                    ],
                ]
            ]
        ...
        $this->start_controls_section(
            'style_title', [
                'label' => __( 'Style Review Section', 'melan-companion' ),
        ...
        $this->add_control(
            'sec_overlay_col', [
                'label' => __( 'Section Overlay Color', 'melan-companion' ),
                    ...
                    <div class="testmonial_active owl-carousel">
                        ...
                        if( is_array( $reviews ) && count( $reviews ) > 0 ){
                            foreach ( $reviews as $review ) {
                                ...
                                $client_img = !empty( $review['client_img']['id'] ) ? wp_get_attachment_image( $review['client_img']['id'], 'melan_np_thumb', '', array( 'alt' => $reviewer_name. ' image' ) ) : '';
                                $quote_icon = MELAN_DIR_ICON_IMG_URI . 'quote-icon.svg';
                                ?>
