...
/**
 *
 * Melan elementor home contact section widget.
 *
 * @since 1.0
 */
class Melan_Home_Contact extends Widget_Base {

	public function get_name() {
		return 'melan-home-contact';
	}

	public function get_title() {
		return __( 'Home Contact', 'melan-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Home Contact Settings', 'melan-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Get Free Quote', 'melan-companion' ),
            ]
        );
        $this->add_control(
            'form_shortcode',
    ...
    $right_img = !empty( $settings['right_img']['id'] ) ? wp_get_attachment_image( $settings['right_img']['id'], 'melan_home_contact_588x500', '', array( 'alt' => 'right image' ) ) : '';
    ?>
