...
/**
 *
 * Melan elementor faq section section widget.
 *
 * @since 1.0
 */
class Melan_Faq_Section extends Widget_Base {

	public function get_name() {
		return 'melan-faq-section';
	}

	public function get_title() {
		return __( 'Faq Section', 'melan-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'faq_contents',
			[
				'label' => __( 'Faq content', 'melan-companion' ),
			]
        );
        ...
        $this->add_control(
            'sec_img',
            [
                'label' => esc_html__( 'Faq Image', 'melan-companion' ),
                'description' => esc_html__( 'Best size is 490x480', 'melan-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Faq Items', 'melan-companion' ),
        ...
        $this->add_control(
            'sec_title',
            [
                'label' => esc_html__( 'Faq Title', 'melan-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'Frequently ask', 'melan-companion' )
            ]
        );
		$this->add_control(
            'faq_items', [
                ...
                'fields' => [
                    [
                        'name' => 'faq_title',
                        'label' => __( 'Faq Title', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Adieus who direct esteem It esteems luckily?', 'melan-companion' ),
                    ],
                    [
                        'name' => 'faq_text',
                        'label' => __( 'Faq Text', 'melan-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Esteem spirit temper too say adieus who direct esteem esteems luckily or picture placing drawing.', 'melan-companion' ),
                    ],
                ],
                'default'   => [
                    [      
     ...
     */
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Inner Styles', 'melan-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'item_icon_col', [
                'label' => __( 'Item Icon Color', 'melan-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'item_title_col', [
                'label' => __( 'Item Title Color', 'melan-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'item_text_col', [
                'label' => __( 'Item Text Color', 'melan-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    $sec_img = !empty( $settings['sec_img']['id'] ) ? wp_get_attachment_image( $settings['sec_img']['id'], 'melan_accordion_thumb_490x480', '', array( 'alt' => $sec_title ) ) : '';
