(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".melan-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".melan-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.melan-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.melan-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.melan-subscribe-newsletter-area');
    if ($subscribe.length) {
